      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 border-t border-background/10">
            <span className="font-body text-background/50 text-xs">Developed by</span>
            <a
              ...
              aria-label="Next Mind - Digital Products That Excite"
            >
              <svg className="w-4 h-4 text-primary" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/>
              </svg>
              <span className="font-body text-background/90 text-sm font-medium">Next Mind</span>
            </a>
          </div>
        </motion.div>
      </div>
